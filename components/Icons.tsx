...
export const ForwardIcon: React.FC<{ className?: string }> = ({ className }) => ( // For "Continue Story"
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
  </svg>
);

export const BagIcon: React.FC<{ className?: string }> = ({ className }) => ( // For "Toggle Side Panel" (Inventory)
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({ className }) => ( // For "Calibrate World"
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.528-1.036.096-2.261-1.06-2.261H9.837c-1.156 0-1.589 1.225-1.06 2.26l2.497 3.031z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L10.5 16.5m.922-1.332L9.044 11.5M10.5 16.5l-1.456-1.043M11.42 15.17l-1.044 1.456M11.42 15.17L12.75 14.5M6.75 8.25l.875.875M16.5 10.5l-1.375 1.375M15.125 9.125L13.75 10.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h.008v.008H3.75V12zm0-3.75h.008v.008H3.75V8.25zm0 7.5h.008v.008H3.75v-.008zM7.5 12h.008v.008H7.5V12zm0-3.75h.008v.008H7.5V8.25zm0 7.5h.008v.008H7.5v-.008zM11.25 12h.008v.008h-.008V12zm0-3.75h.008v.008h-.008V8.25zm0 7.5h.008v.008h-.008v-.008z" />
  </svg>
);

export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className }) => ( // For "Reset Game"
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
  </svg>
);

export const MapIcon: React.FC<{ className?: string }> = ({ className }) => ( // Kept for GameView, updated to generic grid
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3.68-3.091a1.993 1.993 0 00-1.055-.328H8.25c-1.105 0-2-.912-2-2.033V11.119c0-.98.602-1.84 1.485-2.149A46.452 46.452 0 0110.5 8.411c.34-.027.678-.051.998-.071c.32-.02.64-.036.963-.049a4.498 4.498 0 014.286 1.085zM4.5 13.489c.884-.284 1.5-1.128 1.5-2.097V7.107c0-1.136.847-2.1 1.98-2.193.34-.027.68-.052 1.02-.072V2.75l3.68 3.091c.42.353.936.57 1.483.655V11.97c0 .98-.602 1.84-1.485 2.149A46.409 46.409 0 0113.5 14.589c-.34.027-.678.051-.998.071c-.32.02-.64.037-.963.049a4.498 4.498 0 01-4.286-1.085z" />
  </svg>
);

export const ClipboardDocumentListIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75c0-.231-.035-.454-.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5M6.75 7.5L6 12m0 0l.75-4.5M6 12l-1.5.375" />
  </svg>
);

export const WindowIcon: React.FC<{ className?: string }> = ({ className }) => ( // For App Title
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 3.75H4.5A2.25 2.25 0 002.25 6v12A2.25 2.25 0 004.5 20.25h15A2.25 2.25 0 0021.75 18V6A2.25 2.25 0 0019.5 3.75zm-15 1.5h15m-15 3H12m-9.75 3h15m-15 3H12" />
  </svg>
);
